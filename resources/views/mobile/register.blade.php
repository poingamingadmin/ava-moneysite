                        ...
                        <div class="register_form_one">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">
                                        * Username must be 6–12 characters, using only letters and/or numbers (0–9), no
                                        symbols (@#$~%&) <br>
                                        e.g.: <b>username1</b>
                                    </small>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">
                                        * Minimum 8 characters including at least 1 letter, 1 number, and 1 special
                                        character (!@#$%^&amp;*()_+) <br>
                                        e.g.: <b>password1@</b>
                                    </small>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">* Please enter a valid email address for password
                                        recovery</small>
                                </div>
                            </div>
                        ...
                        <div class="register_form_two">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">
                                        * The registered name must match the bank account holder used for deposits and
                                        withdrawals.
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small class="text-left">
                                        * Make sure your account is Valid, Active, and not already registered on this
                                        site
                                    </small>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            &nbsp;By clicking the REGISTER button, I confirm that I am at least 18 years
                                            old.
                            ...
                            $regi_validator = $("#registerForm1").validate({
                                ...
                                messages: {
                                    ...
                                    name: {
                                        ...
                                        pattern: "Full name must only contain letters and spaces, consecutive spaces are not allowed",
                                        minlength: "At least 3 characters are required",
                                    },
                                    user_name: {
                                        required: "Username is required",
                                        pattern: "Username can only contain letters and numbers",
                                        minlength: "Minimum of 6 characters required",
                                        maxlength: "Maximum of 12 characters allowed",
                                        remote: "Username is not available"
                                    },
                                    acc_no: {
                                        required: "Bank account number is required",
                                        pattern: "Bank account number must contain numbers only",
                                        minlength: function(element) {
                                            var min_length = $("#acc_no").attr('minlength');
                                            var str = "A minimum of :acc_length characters is required";
                                            return str.replace(":acc_length", min_length);
                                        },
                                        maxlength: "Maximum of 20 characters allowed",
                                        remote: "Bank account number is already registered"
                                    },
                                    agency_code: {
                                        required: "Agency Code is required",
                                        pattern: "Agency Code must contain numbers only",
                                        minlength: function(element) {
                                            var min_length = 1;
                                            var str = "A minimum of :acc_length characters is required";
                                            return str.replace(":acc_length", min_length);
                                        },
                                        maxlength: "Maximum of 4 characters allowed",
                                    },
                                    bank_name: {
                                    ...
                                    line_id: {
                                        ...
                                        maxlength: "Maximum of 50 characters allowed",
                                    ...
                                    mobileno: {
                                        ...
                                        minlength: function(element) {
                                            ...
                                            return str.replace(":mobno_minlength", min_length);
                                        },
                                        maxlength: function(element) {
                                            var max_length = $("#mobileno").attr('maxlength');
                                            var str = "A maximum of :mobno_maxlength characters is allowed";
                                            return str.replace(":mobno_maxlength", max_length);
                                        },
                                        pattern: "Mobile number must contain numbers only",
                                        remote: "Mobile number is not available"
                                    },
                                    identity: {
                                    ...
                                    ifsc_code: {
                                        ...
                                        minlength: "Minimum of 11 characters required",
                                        maxlength: "Maximum of 11 characters allowed",
                                    },
                                    currency: {
