            ...
            <div>
                ...
                <div class="pull-right footerlink">
                    <ul class="clearfix">
                        <li>
                            <div class="copyright">
                                ©2024 {{ $siteConfig->site_name }} . All rights reserved | 18+ | v1.60
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="footerlink">
                    <ul class="clearfix">
                        <li><a href="{{ url('info/faq-general') }}">About Us</a></li>
                        <li>|</li>
                        <li><a href="{{ url('info/faq-banking') }}">Banking Info</a></li>
                        <li>|</li>
                        <li><a href="{{ url('info/faq-general') }}">Info Center</a></li>
                        <li>|</li>
                        <li><a href="{{ url('contact-us') }}">Contact Us</a></li>
                        <li>|</li>
                        <li><a href="{{ url('info/terms-terms_conditions') }}">Terms & Conditions</a></li>
                        <li>|</li>
            ...
            <div class="clearfix mt-3">
                ...
                <div class="col-lg-4 pull-right text-right social-icons" style="padding: 0px;">
                    <a href="/" target="_blank" data-toggle="tooltip" data-placement="top"
                        title="Follow us on Facebook" class="button icon circle is-outline facebook"><i
                            class="icon-facebook"></i></a>
                    <a href="https://www.twitter.com/" target="_blank" data-toggle="tooltip" data-placement="top"
                        title="Tweet us!" class="button icon circle is-outline twitter"><i
                            class="icon-twitter"></i></a>
                    <a href="https://www.instagram.com/" target="_blank" data-toggle="tooltip" data-placement="top"
                        title="Follow us on Instagram" class="button icon circle is-outline instagram"><i
                            class="icon-instagram"></i></a>
                    <a href="https://" target="_blank" data-toggle="tooltip" data-placement="top"
                        title="Watch our YouTube videos to learn more!"
                    ...
                    <div class="col-md-2 col-sm-4">
                        <div class="pull-right text-right footerlink">
                            ...
                            <ul class="text-t600 mt-2">
                                <li><h2><i class="icon-chrome"></i></h2></li>
                                <li><h2><i class="icon-firefox"></i></h2></li>
                                <li class="pr-0"><h2><i class="icon-safari"></i></h2></li>
                            </ul>
                        </div>
                    </div>
                </div>
